...
class User(UserMixin, db.Model):
    ...
    zip_code = db.Column(db.String(6), default=None)
    street = db.Column(db.String(150), default=None)
    house_number = db.Column(db.Integer, default=None)
    flat_number = db.Column(db.Integer, default=None)
